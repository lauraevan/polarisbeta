...
const CHANNELS: Channel[] = [
  { id: "stadium", name: "Stadium", category: "Sports", domain: "watchstadium.com", emoji: "🏟️", accent: "30 80 180", tagline: "Live sports · highlights", popular: true, highlight: true, streams: [{ label: "Stadium", url: "https://bcovlive-a.akamaihd.net/r21fb8503a4a74c9a91d4a16448514ed8/us-east-1/5994000126001/profile_0/chunklist.m3u8" }] },
  { id: "fifa-plus", name: "FIFA+", category: "Sports", domain: "fifa.com", emoji: "⚽", accent: "40 130 70", tagline: "Soccer replays · live windows", popular: true, highlight: true, streams: [{ label: "FIFA+", url: "https://amg17560-fifa-amg17560c1-rakuten-uk-4891.playouts.now.amagi.tv/playlist/amg17560-fifa-fifaplus-rakutenuk/playlist.m3u8" }] },
