...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Polaris EDU" },
      { name: "description", content: "Education K-12 Powering Your Future" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Polaris EDU" },
      { property: "og:description", content: "Education K-12 Powering Your Future" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Polaris EDU" },
      { name: "twitter:description", content: "Education K-12 Powering Your Future" },
